...
//returns number of isolated blocks of a given color
...
*/
    ...
    //groups of a color with least isolated blocks should be picked first 
    if(command == 'i'){
        //create map of colors
        //maps color to number of isolated pairs of each color
